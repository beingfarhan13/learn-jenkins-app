            ...
            steps {
                withCredentials([usernamePassword(credentialsId: 'myAwsS3Passkey', passwordVariable: 'AWS_SECRET_ACCESS_KEY', usernameVariable: 'AWS_ACCESS_KEY_ID')]) {
                    sh '''
                        ...
                        aws ecs update-service --cluster learn-jenkins-app-20250904 --service learn-jenkins-app-taskDefinition-prod-service  --task-definition learn-jenkins-taskDefinition-prod:$LATEST_TD_DEFINITION
                        # aws ecs wait services-stable --cluster learn-jenkins-app-20250904 --services learn-jenkins-app-taskDefinition-prod-service
